...
class WebRTC extends SignallingServer {
    ...
    /**
     * Sends a JSON string through WebRTC to peers
     *
    ...
    /**
     * Decides what to do with a message received from peers
    ...
    handleDataChannelMessage(message) {
        ...
        switch (data.type) {
            case 'cursor':
                UI.handlePeerCursor(data.message.selection, data.message.direction, data.sender);
                break;
            case 'code':
